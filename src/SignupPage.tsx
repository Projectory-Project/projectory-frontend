                        ...
                        <div className="modal-content rounded-4 shadow">
                            ...
                            <div className="modal-body p-5 pt-0">
                                ...
                                <div className="form-floating mb-3">
                                    <input type="text" id="username" className="form-control rounded-3"  placeholder="username"/>
                                ...
                                <button id="signUp" className="w-100 mb-2 btn btn-lg rounded-3 btn-primary">Sign up</button>
                                <TermsOfUse />
